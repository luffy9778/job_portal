    ...
    <nav className="bg-white border-gray-200 dark:bg-gray-900 relative">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <button
          ...
          aria-expanded={showButton ? "true" : "false"}
        >
        ...
        <div
          ...
          } w-full md:block md:w-auto absolute md:static right-0 top-0 md:flex`}
          id="navbar-default"
        >
          <ul className="font-medium flex flex-col md:flex-row md:space-x-8 bg-white md:bg-transparent dark:bg-gray-800 md:dark:bg-gray-900 md:ml-auto md:justify-end p-4 md:p-0 border md:border-0 rounded-lg shadow md:shadow-none">
            ...
            <li>
              <a
                href="#about"
                className="block py-2 px-3 text-gray-900 rounded-sm hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-orange-700 md:p-0 dark:text-white md:dark:hover:text-orange-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent"
              >
                About
              </a>
            </li>
